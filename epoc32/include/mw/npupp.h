...
#define CallNPP_NewProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7) \
 ...
 #else/* __SYMBIAN32__ */
  typedef NPError (* NP_LOADDS NPP_NewUPP)(NPMIMEType pluginType, NPP instance,
...
void    NP_LOADDS NPP_StreamAsFile(NPP instance, NPStream* stream,
                                   const TDesC& fname);
  typedef void (* NP_LOADDS NPP_StreamAsFileUPP)(NPP instance, NPStream* stream,
                                   const TDesC& fname);
  #define NewNPP_StreamAsFileProc(FUNC)   \
      ((NPP_StreamAsFileUPP) (FUNC))
  #define CallNPP_StreamAsFileProc(FUNC,  ARG1, ARG2, ARG3)   \
...
#define CallNPP_URLNotifyProc(FUNC,  ARG1, ARG2, ARG3, ARG4)    \
 ...
 #else/* __SYMBIAN32__ */
  typedef void (* NP_LOADDS NPP_URLNotifyUPP)(NPP instance, const TDesC& url,
...
#define CallNPN_GetURLNotifyProc(FUNC, ARG1, ARG2, ARG3, ARG4) \
  ...
  #define CallNPN_GetURLNotifyProc(FUNC, ARG1, ARG2, ARG3, ARG4)    \
      (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4))
 #else/* __SYMBIAN32__ */
  typedef NPError (* NP_LOADDS NPN_GetURLNotifyUPP)(NPP instance, const TDesC& url,
...
#define CallNPN_PostURLNotifyProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7) \
  ...
  #define CallNPN_PostURLNotifyProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7) \
      (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4), (ARG5), (ARG6), (ARG7))
 #else/* __SYMBIAN32__ */
  typedef NPError (* NP_LOADDS NPN_PostURLNotifyUPP)(NPP instance, const TDesC& url,
                                    const TDesC* target,
...
#define CallNPN_GetURLProc(FUNC, ARG1, ARG2, ARG3) \
  ...
  #define CallNPN_GetURLProc(FUNC, ARG1, ARG2, ARG3)    \
      (*(FUNC))((ARG1), (ARG2), (ARG3))
 #else/* __SYMBIAN32__ */
  typedef NPError (* NP_LOADDS NPN_GetURLUPP)(NPP instance, const TDesC& url,
                             const TDesC* target);
  #define NewNPN_GetURLProc(FUNC)   \
      ((NPN_GetURLUPP) (FUNC))
  #define CallNPN_GetURLProc(FUNC, ARG1, ARG2, ARG3)    \
...
#define CallNPN_PostURLProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6) \
  ...
  #define CallNPN_PostURLProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6) \
      (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4), (ARG5), (ARG6))
 #else/* __SYMBIAN32__ */
  typedef NPError (* NP_LOADDS NPN_PostURLUPP)(NPP instance, const TDesC& url,
                              const TDesC* target,
                              const TDesC& buf, NPBool file);
  #define NewNPN_PostURLProc(FUNC)    \
      ((NPN_PostURLUPP) (FUNC))
  #define CallNPN_PostURLProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5) \
      (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4), (ARG5))
 #endif /* __SYMBIAN32__ */
#endif
...
#define CallNPN_NewStreamProc(FUNC, npp, type, window, stream)    \
 ...
 #else/* __SYMBIAN32__ */
  typedef NPError (* NP_LOADDS NPN_NewStreamUPP)(NPP instance, NPMIMEType type,
...
#define CallNPN_StatusProc(FUNC, npp, msg)    \
  ...
  #define CallNPN_StatusProc(FUNC, npp, msg)    \
      (*(FUNC))((npp), (msg)) 
 #else/* __SYMBIAN32__ */
  typedef void (* NP_LOADDS NPN_StatusUPP)(NPP instance, const TDesC& message);
  #define NewNPN_StatusProc(FUNC)   \
      ((NPN_StatusUPP) (FUNC))
  #define CallNPN_StatusProc(FUNC, npp, msg)    \
      (*(FUNC))((npp), (msg)) 
...
#define CallNPN_UserAgentProc(FUNC, ARG1)               \
  ...
  #define CallNPN_UserAgentProc(FUNC, ARG1)               \
          (*(FUNC))((ARG1))
 #else/* __SYMBIAN32__ */
  typedef const TDesC* (* NP_LOADDS NPN_UserAgentUPP)(NPP instance);
  #define NewNPN_UserAgentProc(FUNC)              \
          ((NPN_UserAgentUPP) (FUNC))
  #define CallNPN_UserAgentProc(FUNC, ARG1)               \
          (*(FUNC))((ARG1))
...
#define CallNP_GetMIMEDescEntryProc(FUNC)   \
 ...
 #else/* __SYMBIAN32__ */
  typedef const TDesC* (* NP_LOADDS NP_GetMIMEDescriptionUPP)();
 #endif /* __SYMBIAN32__ */
...
#else
IMPORT_C const TDesC* NP_GetMIMEDescription(void);
IMPORT_C NPError    NP_Initialize(NPNetscapeFuncs*, NPPluginFuncs*);
IMPORT_C void     NP_Shutdown(void);
IMPORT_C NPError    NP_GetValue(void *future, NPPVariable aVariable, void *aValue);
#endif /* __SYMBIAN32__ */
