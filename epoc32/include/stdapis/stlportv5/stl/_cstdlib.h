...
#  if ((!defined (_STLP_MSVC_LIB) || (_STLP_MSVC_LIB < 1310) || defined(UNDER_CE)) && !(defined(__SYMBIAN32__) && defined(__GCCXML__)))
...
#  if ((!defined (_STLP_MSVC_LIB) || (_STLP_MSVC_LIB < 1400) || defined (_STLP_USING_PLATFORM_SDK_COMPILER) || defined(UNDER_CE)) && !(defined(__SYMBIAN32__) && defined(__GCCXML__)))
