...
protected:
  ...
  _STLP_DECLSPEC static const mask* _STLP_CALL classic_table() _STLP_NOTHROW;
...
public:
  _STLP_DECLSPEC explicit ctype_byname(const char*, size_t = 0, _Locale_name_hint* __hint = 0);
...
public:
  ...
  _STLP_DECLSPEC explicit ctype(size_t __refs = 0) ;
...
public:
  _STLP_DECLSPEC explicit ctype_byname(const char* __name, size_t __refs = 0, _Locale_name_hint* __hint = 0);
